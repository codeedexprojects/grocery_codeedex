...
router.post('/', checkPermission('create_notification'), upload.single('image'), cloudinaryMapper, notificationController.createNotification);
...
router.patch('/:id', checkPermission('update_notification'), upload.single('image'), cloudinaryMapper, notificationController.updateNotification);
